...
export enum DS_COLOR {
  ...
  LIGHT_BACKGROUND_PRIMARY_START = '#E2F6FF',
  LIGHT_BACKGROUND_PRIMARY_END = '#FDF7F9',

  LIGHT_BACKGROUND_SECONDARY_START = '#C2C1FF',
  LIGHT_BACKGROUND_SECONDARY_END = '#FFFBFF',
  ...
  DARK_BACKGROUND_PRIMARY_START = '#2B3B72',
  DARK_BACKGROUND_PRIMARY_END = '#1F54B2',

  DARK_BACKGROUND_SECONDARY_START = '#504CCB',
  DARK_BACKGROUND_SECONDARY_END = '#8482FF',
